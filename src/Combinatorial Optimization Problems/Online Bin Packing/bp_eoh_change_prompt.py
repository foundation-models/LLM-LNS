...
if __name__ == '__main__':
    ...
    paras_config.set_paras(
        ...
        llm_api_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT", "your_llm_endpoint"),
        llm_api_key=os.getenv("AZURE_OPENAI_API_KEY", "your_api_key"),
        llm_model=os.getenv("AZURE_OPENAI_MODEL", "gpt-4o-mini"), # Or other compatible model
